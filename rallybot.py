...
class Bot:
    settings = {
        ...
        "urls": {
            ...
            "rally-pack": "http://ultimate-a.cygames.jp/ultimate/gacha/index/0?hash=free",
            "rally-user": "http://ultimate-a.cygames.jp/ultimate/cheer/index/",
            "comment-check": "http://ultimate-a.cygames.jp/ultimate/cheer/comment_check",
    ...
    def setRallyUser(self, rally_user):
        self.rally_user = rally_user

    def getRallyUser(self, rally_user):
        return self.rally_user
    ...
    def buyRallyCards(self):
        maxPurchase = int(self.getRallyPoints() / 200)
