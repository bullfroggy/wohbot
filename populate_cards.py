...
def parse_card(param_id):
    ...
    if card_exists and archive_soup and rally_soup:
        str_join = '\t'.join([global_id, name, name_prefix, name_id, root_name, image_id, rarity, alignment, min_rarity, base_id, v, desc, base_atk, base_def, pwr_req, gender, faction, silver, max_level, max_mastery,  ability, usage, effect, effect_strength, effect_cards_affected, effect_attribute, effect_player, effect_direction])
